...
export class ApiError extends Error {
  ...
  constructor(message: string, status: number) { //[cite: 2]
...
async function request<T>( //[cite: 2]
  ...
  if (!(options.body instanceof FormData)) { //[cite: 2]
  ...
  const response = await fetch(`${API_BASE_URL}${endpoint}`, { //[cite: 2]
    ...options, //[cite: 2]
    headers, //[cite: 2]
  });
...
export const api = {
  get: <T>(endpoint: string, options?: RequestInit) => //[cite: 2]
    request<T>(endpoint, { ...options, method: "GET" }), //[cite: 2]

  post: <T>(endpoint: string, body?: unknown, options?: RequestInit) => //[cite: 2]
    request<T>(endpoint, { //[cite: 2]
      ...options, //[cite: 2]
      method: "POST", //[cite: 2]
      body: body ? JSON.stringify(body) : undefined, //[cite: 2]
    }),

  put: <T>(endpoint: string, body?: unknown, options?: RequestInit) => //[cite: 2]
    request<T>(endpoint, { //[cite: 2]
      ...options, //[cite: 2]
      method: "PUT", //[cite: 2]
      body: body ? JSON.stringify(body) : undefined, //[cite: 2]
  ...
  patch: <T>(endpoint: string, body?: unknown, options?: RequestInit) => //[cite: 2]
    request<T>(endpoint, { //[cite: 2]
      ...options, //[cite: 2]
      method: "PATCH", //[cite: 2]
      body: body ? JSON.stringify(body) : undefined, //[cite: 2]
  ...
  del: <T>(endpoint: string, options?: RequestInit) => //[cite: 2]
